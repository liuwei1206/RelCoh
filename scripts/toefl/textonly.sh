...
# for roberta for param in "1 64 5e-3 0.0" "2 8 5e-3 0.2" "6 32 1e-3 0.0" "7 48 5e-3 0.2" "8 48 5e-3 0.1" "9 48 1e-3 0.1" "10 8 1e-3 0.0"
for param in "3 16 1e-3 0.1" "5 48 1e-3 0.2" "6 32 1e-3 0.0"
do
    set -- $param
