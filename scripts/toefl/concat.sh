...
# for robertafor param in "1 32 1e-3 0.2" "2 128 1e-3 0.0" "6 32 1e-3 0.0" "7 48 1e-3 0.3" "8 16 1e-3 0.3" "9 64 5e-3 0.2" "10 64 1e-3 0.3"
for param in "3 32 1e-3 0.0" "5 16 1e-3 0.0" "6 32 1e-3 0.3"
do
    set -- $param
    ...
    python3 fast/fast_flat_tran.py --do_train \
                                   ...
                                   --label_list="1, 2, 3" \
                                   --fold_id=$1 \
                                   --model_type="transformer_sent_rel" \
